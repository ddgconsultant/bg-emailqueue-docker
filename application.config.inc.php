<?php
	...
	define("API_KEY", "asfKkj3=m2345k");  // The secret key to access Emailqueue via API. Change it to a random string of your choice.

	define("FRONTEND_USER", "user"); // The user name for the frontend. Change it to your desired user.
	define("FRONTEND_PASSWORD", "password"); // The password for the frontend. Change it to a strong password of your choice.
	...
	define("SMTP_AUTHENTICATION_USERNAME", "AKIAJ2WOHYTGLUEH6RRQ");
	define("SMTP_AUTHENTICATION_PASSWORD", "AqthhMsiWUpah9xE7dnRrUIknwT0ESVUrXZ5lxOYsv5H");
